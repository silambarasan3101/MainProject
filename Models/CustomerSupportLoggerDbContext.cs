...
public partial class CustomerSupportLoggerDbContext : DbContext
{
    public CustomerSupportLoggerDbContext()
    {
    }

    public CustomerSupportLoggerDbContext(DbContextOptions<CustomerSupportLoggerDbContext> options)
        : base(options)
    {
    }
