...
namespace CustomerSupportLogger.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public UserInfoesController(CustomerSupportLoggerDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserInfos != null ? 
                          ...
                          Problem("Entity set 'CustomerSupportLoggerDbContext.UserInfos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,Email,Password")] UserInfo userInfo)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    return RedirectToAction("Create", "CustLogInfoes"); // Redirect to the Create action in CustLogInfoesController
                }
                else
                {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CustomerSupportLoggerDbContext.UserInfos'  is null.");
            }
            var userInfo = await _context.UserInfos.FindAsync(id);
            if (userInfo != null)
            {
