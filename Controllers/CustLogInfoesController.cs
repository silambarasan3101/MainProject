...
namespace CustomerSupportLogger.Controllers
{
    public class CustLogInfoesController : Controller
    {
        ...
        public CustLogInfoesController(CustomerSupportLoggerDbContext context)
        {
            _context = context;
        }
        ...
        {
            var customerSupportLoggerDbContext = _context.CustLogInfos.Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CustomerSupportLoggerDbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
